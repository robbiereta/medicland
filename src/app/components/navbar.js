      ...
      <div className={containerClass}>
          ...
          <Offcanvas show={showTwo} onHide={handleCloseTwo} placement="end">
            ...
            <div className="offcanvas-footer p-4 border-top text-center">
              <ul className="list-unstyled social-icon social mb-0">
                <li className="list-inline-item mb-0">
                  <Link
                    href="https://1.envato.market/doctris-react"
                    target="_blank"
                    className="rounded"
                  >
        ...
        <div id="navigation" style={{ display: isMenu ? "block" : "none" }}>
          <ul className={manuClass}>
            <li
              className={`${
                ["", "/index-three"].includes(manu) ? "active" : ""
            ...
            >
              ...
              <ul className="submenu">
                <li className={manu === "/pharmacy" ? "active" : ""}>
                  <Link href="/pharmacy" className="sub-menu-item">
                    Pharmacy
                  </Link>
                </li>
                <li className={manu === "/pharmacy-shop" ? "active" : ""}>
                  <Link href="/pharmacy-shop" className="sub-menu-item">
                    Shop
                  </Link>
                </li>
                <li
                  className={
                    manu === "/pharmacy-product-detail" ? "active" : ""
                  }
                >
                  <Link
                    href="/pharmacy-product-detail"
                ...
                <li className={manu === "/pharmacy-shop-cart" ? "active" : ""}>
                  <Link href="/pharmacy-shop-cart" className="sub-menu-item">
                    Shop Cart
                  </Link>
                </li>
                <li className={manu === "/pharmacy-checkout" ? "active" : ""}>
                  <Link href="/pharmacy-checkout" className="sub-menu-item">
                    Checkout
                  </Link>
                </li>
                <li className={manu === "/pharmacy-account" ? "active" : ""}>
                  <Link href="/pharmacy-account" className="sub-menu-item">
                    Account
                  </Link>
                </li>
              </ul>
